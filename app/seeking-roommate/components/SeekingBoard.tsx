...
// Component: SeekingBoard (Main View with Filtering & Post Grid)
// ============================================================
...
import CreateSeekingModal from './CreateSeekingModal';
...
export default function SeekingBoard({
  posts,
  zones,
  isLoggedIn,
  isAdmin
