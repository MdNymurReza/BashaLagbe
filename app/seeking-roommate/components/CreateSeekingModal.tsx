...
// Component: CreateSeekingModal (Form to post seeking advertisement)
// ============================================================
...
import { createSeekingSchema } from '../validation';
...
export default function CreateSeekingModal({ isOpen, onClose, zones, onSuccess }: CreateSeekingModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    budget_min: '',
    budget_max: '',
    property_type: 'single_room' as const,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid-2">
          ...
          <div className="form-group">
            ...
            <CustomSelect
              ...
              onChange={val => setFormData({...formData, property_type: val as any})}
              options={[
                { value: 'any', label: 'Any' },
        ...
        <div className="grid-2">
          <div className="form-group">
            ...
            <CustomSelect
              ...
              onChange={val => setFormData({...formData, preferred_gender: val as any})}
              options={[
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '24px' }}>
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? 'Posting...' : 'Post Seeking Ad'}
          </button>
        </div>
      </form>
    </Modal>
