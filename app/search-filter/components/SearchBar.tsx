...
// Component: SearchBar (standalone hero search form)
// ============================================================
...
interface SearchBarProps {
  /** Zones to show in the dropdown. If omitted, a hardcoded fallback is used. */
...
export default function SearchBar({ zones }: SearchBarProps) {
  ...
  return (
    <form className="hero-search" onSubmit={handleSearch}>
      ...
      <button type="submit" className="btn btn-primary hs-btn">
        Search Listings
      </button>
    </form>
  );
